...
public class DetailInstructionActivity extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        ListView lvDetailInstruction = tabDetail.findViewById(R.id.lvDetailInstruction);
        ...
        ListView lvStationInstruction = tabStation.findViewById(R.id.lvStationInstruction);
