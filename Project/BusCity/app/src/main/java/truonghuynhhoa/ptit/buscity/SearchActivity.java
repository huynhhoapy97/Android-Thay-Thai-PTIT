...
public class SearchActivity extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        languages = getSharedPreferences("languages", MODE_PRIVATE);
        ...
        routeAdapter = new RouteAdapter(SearchActivity.this, R.layout.item_route, language);
        ...
        routeSavedAdapter = new RouteSavedAdapter(SearchActivity.this, R.layout.item_route_saved, language);
    ...
    class BusRouteListTask extends AsyncTask<Void, Void, ArrayList<BusRoute>>{
        ...
        protected ArrayList<BusRoute> doInBackground(Void... voids) {
            ...
            try {
                URL url = new URL("http://buscity.somee.com/api/busroute");
